...
class Rectangle:
    ...
    def _in_range(self, value: float, min: float, max: float) -> bool:
    ...
    def contains(self, point: Point2D, tolerance=0) -> bool:
        ...
        return self._in_range(ll_px, -tolerance, self._dx + tolerance) and self._in_range(ll_py, -tolerance, self._dy + tolerance)
